...
├── modules/
│   ├── access_level/                # Access Level submodule
│   │   ├── main.tf
│   │   ├── variables.tf
│   │   ├── outputs.tf
│   │   └── README.md
│   ├── regular_service_perimeter/   # Regular Service Perimeter submodule
│   │   ├── main.tf
│   │   ├── variables.tf
│   │   ├── outputs.tf
│   │   └── README.md
│   └── bridge_service_perimeter/    # Bridge Service Perimeter submodule (optional)
│       ├── main.tf
│       ├── variables.tf
│       ├── outputs.tf
│       └── README.md
...
- `basic/` - Simple single perimeter setup
- `advanced/` - Multi-perimeter with complex access rules
- `multi_perimeter/` - Multiple independent perimeters
...
This module includes Terraform validation and formatting checks. Before submitting a PR:
...
- [Terraform Google Provider - VPC Service Controls](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/access_context_manager_access_policy)
- [VPC Service Controls Best Practices](https://cloud.google.com/vpc-service-controls/docs/best-practices)
...
### Version 1.0.0
- Initial release
- Support for Access Policies, Service Perimeters, and Access Levels
